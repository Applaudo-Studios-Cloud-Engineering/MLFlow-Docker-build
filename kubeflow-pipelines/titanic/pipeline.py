...
@dsl.pipeline(
    ...
    pipeline_root='gs://data-bucket-6929d24320ef4e55/dataTrain/titanic/build',
)
def preprocessing_pipeline(path: str = 'gs://data-bucket-6929d24320ef4e55/data/titanic/data.csv'):
